...
defaultDir="../revenue-attribution-sbclone/main"
...
echo_attention "Pushing Revenue Attribution Salesforce org configuration (Smartbytes Clone variant) in Main Default to the Org. This will take a few minutes."
